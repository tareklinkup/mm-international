        ...
        methods: {
            ...
            getPurchase() {
                axios.post('/get_purchases', {
                    ...
                    this.purchase.supplier_id = purchase.Supplier_SlNo;
                    ...
                    this.purchase.total_price = purchase.PurchaseMaster_TotalAmount;
                    ...
                    r.purchaseDetails.forEach(product => {
                        let cartProduct = {
                            ...
                            total_amount: product.PurchaseDetails_TotalAmount
                        }
