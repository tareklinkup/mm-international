        ...
        data() {
            return {
                requisition: {
                    ...
                    requisition_no: '<?php echo $invoice; ?>',
        ...
        methods: {
            ...
            addToCart() {
                ...
                this.carts.forEach(ele => {
                    if (parseInt(ele.vehicle_id) == parseInt(data.vehicle_id) && parseInt(ele.parts_id) == parseInt(data.parts_id)) {
            ...
            async getRequisition() {
                await axios.post('/get-all-requisitions', {
                    requisition_id: this.requisition.requisition_id
                }).then(res => {
                    console.log(res);
                    let data = res.data.reqDetails;
                    data.forEach(element => {
                        let data = {
                            vehicle_id: element.vehicle_id,
                            vehicle_reg_no: element.vehicle_reg_no,
                            parts_id: element.parts_id,
                            parts_name: element.Product_Name,
