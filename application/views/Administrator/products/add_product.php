		...
		<div class="row" style="margin-top: 10px;margin-bottom:15px;border-bottom: 1px solid #ccc;padding-bottom: 15px;">
			<div class="col-md-6">
				<div class="form-group clearfix">
					<label class="control-label col-md-4">Parts Id:</label>
					<div class="col-md-7">
				...
				<div class="form-group clearfix">
					<label class="control-label col-md-4">Parts Name:</label>
					<div class="col-md-7">
			...
			<div class="col-md-6">
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<input type="text" id="purchase_rate" class="form-control" v-model="product.Product_Purchase_Rate" required>
					</div>
				</div>
