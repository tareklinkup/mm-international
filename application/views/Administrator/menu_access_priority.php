...
<div id="userAccess">
    ...
    <div class="row" id="accessRow">
        ...
        <div class="col-md-3">
            ...
            <div class="group">
                <input type="checkbox" id="vehicle" class="group-head" @click="onClickGroupHeads">
                <strong>Vehcile</strong>
                <ul ref="vehicle">
                    <li><input type="checkbox" class="access" value="vehcile-entry" v-model="access"> Vehcile Entry</li>
                    <li><input type="checkbox" class="access" value="vehcile-list" v-model="access"> Vehcile List</li>

                    <li><input type="checkbox" class="access" value="general-service-entry" v-model="access"> General
                        Service Entry</li>

                    <li><input type="checkbox" class="access" value="license-update" v-model="access"> License Update
                    </li>

                    <li><input type="checkbox" class="access" value="add-job-card" v-model="access">Add Job Card</li>

                    <li><input type="checkbox" class="access" value="requisition_entry" v-model="access"> Requisition
                        Entry</li>

                    <li><input type="checkbox" class="access" value="order" v-model="access">Make Purchase Order </li>
                    <li><input type="checkbox" class="access" value="direct-purchase" v-model="access">Direct Purchase
                    </li>
                    <li><input type="checkbox" class="access" value="received-challan-update" v-model="access">Received
                        Challan Update</li>

                    <li><input type="checkbox" class="access" value="daily-maintenance" v-model="access">Daily
                        Maintenance</li>

                    <li><input type="checkbox" class="access" value="add-accidental-record" v-model="access">Add
                        Accidental Record</li>

                    <li><input type="checkbox" class="access" value="add-complain-record" v-model="access"> Add Complain
                        Record</li>

                    <li><input type="checkbox" class="access" value="supplier-evaluation" v-model="access">Supplier
                        Evaluation </li>

                    <li><input type="checkbox" class="access" value="supplier-feedback" v-model="access">Supplier
                        Feedback</li>
                    <li><input type="checkbox" class="access" value="customer-feedback" v-model="access">Customer
                        Feedback</li>
                    <li><input type="checkbox" class="access" value="requisition-record" v-model="access"> Requisition
                        Record</li>
                    <li><input type="checkbox" class="access" value="tyre-report" v-model="access"> Tyre Report</li>
                    <li><input type="checkbox" class="access" value="wastage-restore" v-model="access"> Wastage Restore
                    </li>
                    <li><input type="checkbox" class="access" value="currentStock" v-model="access"> Current Stock
                    </li>
                    <li><input type="checkbox" class="access" value="requisitions" v-model="access"> Requisitions
                    </li>
                    <li><input type="checkbox" class="access" value="driving-history" v-model="access"> Driving History
                    </li>
                    <li><input type="checkbox" class="access" value="license-report" v-model="access"> License Report
                    </li>
                    <li><input type="checkbox" class="access" value="sup-evaluation" v-model="access"> Supplier
                        Evaluation
                    </li>
                    <li><input type="checkbox" class="access" value="complain-report" v-model="access"> Complain Report
                    </li>
                    <li><input type="checkbox" class="access" value="accidental-report" v-model="access">Accidental
                        Report
                    </li>
                    <li><input type="checkbox" class="access" value="maintenance-record" v-model="access"> Maintenance
                        Record
                    </li>
                    <li><input type="checkbox" class="access" value="job-card-record" v-model="access"> job Card Record
                    </li>
                    <li><input type="checkbox" class="access" value="general-service-report" v-model="access"> General
                        Service Report
                    </li>
                    <li><input type="checkbox" class="access" value="washing-schedule" v-model="access">Washing Schedule
                        Service Report
                    </li>
                    <li><input type="checkbox" class="access" value="purchase-order-record" v-model="access"> Purchase
                        Order Record
                    </li>
                </ul>
            </div>
