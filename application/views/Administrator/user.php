            ...
            <div class="form-horizontal">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="txtFirstName" id="txtFirstName" placeholder="Full Name" value=""
                                class="form-control" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-1 control-label">:</label>
                        <div class="col-sm-6">
                            <input type="email" name="user_email" id="user_email" onchange="check_email()"
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-1 control-label">:</label>
                        <div class="col-sm-6">
                            <select class="chosen-select form-control" name="Brunch" id="Brunch"
                                data-placeholder="Choose a Brunch...">
                                <option value=""> </option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <select class="chosen-select form-control" name="type" id="type"
                                data-placeholder="Choose a User Type...">
                                <option value=""></option>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-1 control-label">:</label>
                        <div class="col-sm-6">
                            <input type="password" id="assword" name="Password" placeholder="Password"
                                class="form-control" />
                            <div id="usermes" class="col-sm-12"></div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="password" id="rePassword" name="rePassword" placeholder="Re-Password"
                                onchange="password()" class="form-control" />
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-1 control-label"></label>
                        <div class="col-sm-6">
                            <button type="button" onclick="submit()" name="btnSubmit" title="Save"
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="hidden-sm hidden-xs action-buttons">
                                    <a class="blue" href="<?php echo base_url().'userEdit/'.$row->User_SlNo;?>"
                                        onclick="return confirm('Are you sure you want to edit this user?');">
                                        <i class="ace-icon fa fa-pencil bigger-130"></i>
                                    </a>
                                    <?php if($row->userstatus == 'a'){ ?>
                                    <a class="red" href="<?php echo base_url().'userDeactive/'.$row->User_SlNo;?>"
                                        onclick="return confirm('Are you sure you want to deactive this user?');"
                                        title="Deactive">
                                        <i class="ace-icon fa fa-arrow-circle-down bigger-130"></i>
                                    </a>
                                    <?php }else{ ?>
                                    <a class="green" href="<?php echo base_url().'userActive/'.$row->User_SlNo;?>"
                                    ...
                                    <a title="User Access" class="blue"
                                        href="<?php echo base_url().'access/'.$row->User_SlNo;?>">
...
function submit() {
    ...
    var inputdata = 'username=' + username + '&rePassword=' + rePassword + '&txtFirstName=' + txtFirstName +
        '&user_email=' + user_email + '&Brunch=' + Brunch + '&type=' + type;
