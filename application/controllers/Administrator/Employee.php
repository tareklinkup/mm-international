...
class Employee extends CI_Controller
{
    ...
    public function employee_insert()
    {
        ...
        if ($_FILES['attached_file']) {
            ...
            $extension = end($arr);
            // $empName = str_replace(' ', '_', $this->input->post('em_name', true));
            // $empName = $this->input->post('Employeer_id', true);
            $newName =  $employee_code . '.' . $extension;
            move_uploaded_file($_FILES["attached_file"]["tmp_name"], 'uploads/employeePdfFile/' . $newName);
        }
    ...
    public function employee_Update()
    {
        ...
        if ($_FILES['attached_file']) {
            ...
            $extension = end($arr);
            $newName =  $employee_code . '.' . $extension;
            // if (file_exists('uploads/employeePdfFile/' . $newName)) {
            //     unlink('uploads/employeePdfFile/' . $newName);
            // }
    ...
    //     }
    //     $data['title'] = "Driver";
    //     $data['content'] = $this->load->view('Administrator/employee/add_driver', $data, TRUE);
    //     $this->load->view('Administrator/index', $data);
    // }
}
